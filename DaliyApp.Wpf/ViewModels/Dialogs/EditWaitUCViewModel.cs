...
{
    public class EditWaitUCViewModel : IDialogHostService
    {
        private readonly IEventAggregator _eventAggregator;

        public EditWaitUCViewModel(IEventAggregator eventAggregator)
        {
        ...
        {
            WaitInfo = parameters.GetValue<WaitInfoDTO>("OldeWaitInfo");
        }
        ...
        private void SaveDialog()
        {
            ...
            if (DialogHost.IsDialogOpen("RootDialog"))
            {
                ...
                paras.Add("EditWaitInfo", WaitInfo);
